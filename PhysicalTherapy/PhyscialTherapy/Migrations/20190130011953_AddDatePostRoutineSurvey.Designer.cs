...
namespace PhysicalTherapy.Migrations
{
    ...
    [Migration("20190130011953_AddDatePostRoutineSurvey")]
    partial class AddDatePostRoutineSurvey
    {
            ...
            modelBuilder.Entity("PhysicalTherapy.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new { PatientId = 1, AccountType = 2, Bio = "bad back", DateOfBirth = new DateTime(2019, 1, 29, 0, 0, 0, 0, DateTimeKind.Local), Email = "one@email.com", FirstName = "Hung", LastName = "thats-me", PhoneNumber = "911", TherapistId = 1, Username = "Alex" },
                        new { PatientId = 2, AccountType = 2, Bio = "bad knees", DateOfBirth = new DateTime(2019, 1, 29, 0, 0, 0, 0, DateTimeKind.Local), Email = "two@email.com", FirstName = "Also Hung", LastName = "2nd", PhoneNumber = "1800", TherapistId = 1, Username = "hung" },
                        new { PatientId = 3, AccountType = 2, Bio = "accident prone", DateOfBirth = new DateTime(2019, 1, 29, 0, 0, 0, 0, DateTimeKind.Local), Email = "three@email.com", FirstName = "Sike", LastName = "Still-Hung", PhoneNumber = "411", TherapistId = 1, Username = "Tyger" }
                    );
                });
            ...
            modelBuilder.Entity("PhysicalTherapy.Models.Routine", b =>
                {
                    ...
                    b.HasData(
                        new { RoutineId = 1, Date = new DateTime(2019, 1, 29, 0, 0, 0, 0, DateTimeKind.Local), Description = "Routine number 1 not Active", IsComplete = true, IsNew = false, Name = "Routine number 1", PatientId = 1 },
                        new { RoutineId = 2, Date = new DateTime(2019, 1, 29, 0, 0, 0, 0, DateTimeKind.Local), Description = "Routine number 2 Active", IsComplete = false, IsNew = true, Name = "Routine number 2", PatientId = 1 },
                        new { RoutineId = 3, Date = new DateTime(2019, 1, 29, 0, 0, 0, 0, DateTimeKind.Local), Description = "Routine number 3 Active", IsComplete = false, IsNew = true, Name = "Routine number 3", PatientId = 2 }
                    );
                });
            ...
            modelBuilder.Entity("PhysicalTherapy.Models.Therapist", b =>
                {
                    ...
                    b.HasData(
                        new { TherapistId = 1, AccountType = 1, Bio = "New Dr.", DateOfBirth = new DateTime(2019, 1, 29, 0, 0, 0, 0, DateTimeKind.Local), Email = "Test@email.com", FirstName = "DR.", LastName = "Doctor", PhoneNumber = "911", Username = "TygerHugh" }
                    );
                });
